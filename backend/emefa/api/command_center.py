...
def list_initiatives(
    ...
    return request.app.state.command_initiatives.list(include_closed=include_closed)
...
def create_initiative(
    ...
    item = request.app.state.command_initiatives.add(**payload.model_dump())
...
def update_initiative(
    ...
    item = request.app.state.command_initiatives.update(initiative_id, changes)
    if item is None:
